...
describe('Tweet Search functionality', () => {
  ...
  beforeEach(() => {
    ...
    searchEngine.tokenizer = new JsSearch.StopWordsTokenizer(new JsSearch.SimpleTokenizer())
  ...
  it('should find tweets by author name', () => {
    ...
    expect(results).toEqual(expect.arrayContaining([expect.objectContaining({ author: '张三' })]))
  })
